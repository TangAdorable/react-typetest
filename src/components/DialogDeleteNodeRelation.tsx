    ...
    return (
        <>
            <Dialog open={open} onClose={onClose} maxWidth={"md"} sx={{ '& .MuiDialog-paper': { width: '40%' } }}>
                <DialogTitle sx={{ color: '#d1ff33' }} >{checkTypeClick ? "Delete Relationship" : "Delete Node"}</DialogTitle>
                            ...
                            >
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={1.4} container
                                        ...
                                        alignItems="flex-end">
                                        <Button disabled variant="outlined" href="https://www.google.com/" target="_blank" size="small" color="info" >
                                            Manage
                                        </Button>
                                    </Grid>
                                    <Grid item xs={6}>
